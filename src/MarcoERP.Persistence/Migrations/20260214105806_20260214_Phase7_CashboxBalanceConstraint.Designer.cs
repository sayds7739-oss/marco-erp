...
namespace MarcoERP.Persistence.Migrations
{
    ...
    [Migration("20260214105806_20260214_Phase7_CashboxBalanceConstraint")]
    partial class _20260214_Phase7_CashboxBalanceConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarcoERP.Domain.Entities.Treasury.Cashbox", b =>
                {
                    ...
                    b.ToTable("Cashboxes", null, t =>
                        {
                            t.HasCheckConstraint("CK_Cashboxes_Balance_NonNegative", "[Balance] >= 0");
                        });
                });
