...
{
    /// <summary>
    /// ViewModel for the Supplier Import screen.
    /// Supports: pick Excel file -> preview with validation -> import confirmed rows.
    /// </summary>
    public sealed class SupplierImportViewModel : BaseViewModel
    {
        private readonly ISupplierImportService _importService;

        public SupplierImportViewModel(ISupplierImportService importService)
        {
            _importService = importService ?? throw new ArgumentNullException(nameof(importService));

            PreviewRows = new ObservableCollection<SupplierImportRowDto>();
        ...
        public ObservableCollection<SupplierImportRowDto> PreviewRows { get; }
        ...
        private async Task SelectFileAsync()
        {
            ...
            {
                Title = "اختر ملف Excel لاستيراد الموردين",
            ...
            try
            {
                ...
                if (result.IsSuccess && result.Data != null)
                {
                    ...
                    StatusMessage = $"تم تحليل {TotalRows} مورد — {ValidRows} صالح، {InvalidRows} يحتاج مراجعة"
        ...
        private async Task ImportAsync()
        {
            ...
            try
            {
                ...
                if (result.IsSuccess && result.Data != null)
                {
                    ...
                    StatusMessage = $"تم استيراد {ImportedCount} مورد بنجاح" +
                        (FailedCount > 0 ? $" — فشل {FailedCount} مورد" : "");
                }
                else
                {
        ...
        private async Task DownloadTemplateAsync()
        {
            ...
            {
                Title = "حفظ قالب استيراد الموردين",
                Filter = "Excel Files (*.xlsx)|*.xlsx",
                DefaultExt = ".xlsx",
                FileName = "قالب_استيراد_موردين.xlsx"
            };
