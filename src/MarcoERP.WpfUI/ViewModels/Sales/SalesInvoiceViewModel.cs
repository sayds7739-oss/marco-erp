...
namespace MarcoERP.WpfUI.ViewModels.Sales
{
    ...
    /// </summary>
    public sealed partial class SalesInvoiceViewModel : BaseViewModel, IInvoiceLineFormHost
    {
        ...
        private List<SalesInvoiceListDto> _allInvoices = new();
        ...
        private void ApplyFilter()
        {
            ...
            var filtered = string.IsNullOrWhiteSpace(SearchText)
                ...
                : _allInvoices.Where(inv =>
                    (inv.InvoiceNumber?.Contains(SearchText, StringComparison.OrdinalIgnoreCase) == true) ||
                    (inv.CustomerNameAr?.Contains(SearchText, StringComparison.OrdinalIgnoreCase) == true) ||
                    (inv.Status?.Contains(SearchText, StringComparison.OrdinalIgnoreCase) == true) ||
                    inv.NetTotal.ToString("N2").Contains(SearchText, StringComparison.OrdinalIgnoreCase) ||
                    inv.InvoiceDate.ToString("yyyy-MM-dd").Contains(SearchText, StringComparison.OrdinalIgnoreCase)
                ).ToList();
        ...
        // â”€â”€ Totals (preview) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
